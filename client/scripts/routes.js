    ...
    configure() {
        this.$stateProvider
            ...
            .state('view', {
                cache:false,
                url: '/chats/:chatId',
                templateUrl: 'client/templates/view.html',
                controller: 'ViewCtrl as chat'
            ...
            .state('profile1', {
                url: '/profile1',
                templateUrl: 'client/templates/profile1.html',
                controller: 'ProfileCtrl1 as profile',
         ...
         .state('tab.notes', {
            ...
            .state('share', {
            url: '/notes/:noteId',
            templateUrl: 'client/templates/share.html',
